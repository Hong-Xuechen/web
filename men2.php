            ...
            <div class="aa-product-area">
              <div class="aa-product-inner">
				...
				$id2=2;
					...
					$result = mysql_query("SELECT * FROM cloths where d2 like '$id1' and d3 like '$id2' ");
 if($result){
			...
			$id= $row['id'];
				?>
                        ...
                        <li>
                          <figure>
            <a class="aa-product-img" href="#"><img src="images/<? echo $row['d5']; ?>" alt="polo shirt img" width="250"
             height="300"></a>
                            <?
                            echo "<a class='aa-add-card-btn'href='cloth_detail.php?filter=$id'><span class='fa fa-shopping-cart'></span>Add To Cart</a>" ?>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="#"><? echo $row['d1']; ?></a></h4>
                              <span class="aa-product-price"><? echo $row['d4']; ?></span>
                            </figcaption>
                          </figure>                        
